...
namespace Calian_Claudiu_Lab8.Models
{
    public class Book
    {
        ...
        [RegularExpression(@"^[A-Z][a-z]+\s[A-Z][a-z]+$",ErrorMessage ="Numeleautorului trebuie sa fie de forma 'Prenume Nume'"), Required,StringLength(50, MinimumLength = 3)]
